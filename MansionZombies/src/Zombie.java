public class Zombie {
    ...
    public void resetear(Habitacion habitacion) {
        this.setVida_actual((int) ((Math.random() * 2) + 1) + 2 - habitacion.getNum_hab() - 1);
        this.setPuntos_ataque((int) (Math.random() * 2) + 2 - habitacion.getNum_hab() - 1);
    }
